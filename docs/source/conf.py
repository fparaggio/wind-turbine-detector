...
# wind_turbine_detector documentation build
...
from wind_turbine_detector import __version__ as release

# -- Project information -----------------------------------------------------

project = "wind_turbine_detector"
author = "Kedro"
...
htmlhelp_basename = "wind_turbine_detectordoc"
...
latex_documents = [
    (
        master_doc,
        "wind_turbine_detector.tex",
        "wind_turbine_detector Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "wind_turbine_detector",
        "Project wind_turbine_detector codebase.",
        "Data-Science",
    )
]
